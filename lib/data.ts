...
//const px = (id: string, w = 1200, h = 1600) =>
 // `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=${w}&h=${h}&fit=crop`;
  ...
  //const local = (filename: string) => `/public/images/${filename}`;
...
export const portfolioImages: PortfolioImage[] = [
  ...
  // Events
   { id: 'e1', src:"/images/e1.jpg" , alt: 'Concert crowd vibrant lights', category: 'Events', title: 'Electric Nights', span: 'wide' },
   { id: 'e2', src:"/images/e3.jpg" , alt: 'Concert stage lights crowd', category: 'Events', title: 'Stage Symphony', span: 'tall' },
   { id: 'e3', src: "/images/e2.jpg", alt: 'Festival crowd atmosphere', category: 'Events', title: 'Festival Pulse', span: 'normal' },
  ...
  // Lifestyle
  { id: 'l1', src:"/images/l1.JPG", alt: 'Lifestyle photography', category: 'Lifestyle', title: 'Quiet Days', span: 'tall' },
  { id: 'l2', src:"/images/l2.JPG", alt: 'Lifestyle longboard', category: 'Lifestyle', title: 'In Motion', span: 'normal' },
  { id: 'l3', src:"/images/l3.JPG", alt: 'Lifestyle fashion', category: 'Lifestyle', title: 'Golden Hour', span: 'wide' },
];
